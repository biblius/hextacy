...
fn quote_pg_repo_access(
    ...
    quote!(
         ...
         impl #impl_generics ::hextacy::db::RepositoryAccess<#__type> for #ident #ty_generics #where_clause {
            async fn connect<'a>(&'a self) -> Result<#__type, ::hextacy::db::DatabaseError> {
