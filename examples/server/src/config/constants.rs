...
pub const OPEN_SSL_KEY_PATH: &str = "examples/server/openssl/key.pem";

pub const OPEN_SSL_CERT_PATH: &str = "examples/server/openssl/cert.pem";

pub const EMAIL_DIRECTORY: &str = "examples/server/resources/emails";

pub const FAVICON_PATH: &str = "examples/server/resources/favicon.ico";
