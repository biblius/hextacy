    ...
    C: ConnectionTrait + Send + Sync,
{
    ...
    async fn get_by_id(conn: &mut C, user_id: &str) -> Result<User, AdapterError> {
        todo!()
    }
    ...
    async fn get_by_email(conn: &mut C, user_email: &str) -> Result<User, AdapterError> {
        todo!()
    }
    ...
    async fn update_email_verified_at(conn: &mut C, user_id: &str) -> Result<User, AdapterError> {
        todo!()
    }
    ...
    async fn freeze(conn: &mut C, user_id: &str) -> Result<User, AdapterError> {
        todo!()
    }
