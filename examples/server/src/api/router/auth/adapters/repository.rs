...
/* implement! {
    RepositoryComponent : RepositoryApi,
...
impl<Pg, Mg, Connection, MgConn, User, Session, OAuth> RepositoryApi
    for RepositoryComponent<Pg, Mg, Connection, MgConn, User, Session, OAuth>
where
...
pub struct RepositoryComponent<Pg, Connection, User, Session, OAuth>
where
    Pg: Connect<Connection = Connection>,
{
    #[diesel(Connection)]
